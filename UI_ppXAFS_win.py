...
# Form implementation generated from reading ui file 'UI_ppXAFS_dev_win.ui'
#
# Created: Tue Mar 01 07:34:07 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 1221, 631))
        font = QtGui.QFont()
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(940, 550, 251, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.label.setGeometry(QtCore.QRect(13, 34, 51, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.pushButton_13.setGeometry(QtCore.QRect(380, 465, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.pushButton_11.setGeometry(QtCore.QRect(380, 535, 91, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        font.setFamily("Arial")
        font.setPointSize(10)
        self.dsB_post_end.setFont(font)
        ...
        self.label_4.setGeometry(QtCore.QRect(10, 31, 51, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        font.setFamily("Arial")
        font.setPointSize(10)
        self.dsB_post_start.setFont(font)
        ...
        self.pushButton.setGeometry(QtCore.QRect(1090, 7, 111, 41))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.scrollArea.setGeometry(QtCore.QRect(930, 50, 271, 491))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 269, 489))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        self.widget = QtGui.QWidget(self.tab_3)
        self.widget.setGeometry(QtCore.QRect(20, 20, 461, 381))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.widget_2.setGeometry(QtCore.QRect(500, 20, 411, 561))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.combo_fynctype.setGeometry(QtCore.QRect(140, 415, 131, 27))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.combo_fynctype.setFont(font)
        self.combo_fynctype.setObjectName("combo_fynctype")
        self.combo_fynctype.addItem("")
        self.combo_fynctype.addItem("")
        self.combo_fynctype.addItem("")
        self.label_7 = QtGui.QLabel(self.tab_3)
        self.label_7.setGeometry(QtCore.QRect(30, 420, 81, 17))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        self.checkBox_2.setGeometry(QtCore.QRect(310, 418, 141, 22))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        ...
        font = QtGui.QFont()
        font.setPointSize(11)
        self.rB_kpower3.setFont(font)
        self.rB_kpower3.setObjectName("rB_kpower3")
        self.widget_4 = QtGui.QWidget(self.tab_2)
        self.widget_4.setGeometry(QtCore.QRect(20, 140, 791, 451))
        self.widget_4.setObjectName("widget_4")
        self.scrollArea_3 = QtGui.QScrollArea(self.tab_2)
        self.scrollArea_3.setGeometry(QtCore.QRect(850, 70, 351, 501))
        ...
        self.pB_openchi.setGeometry(QtCore.QRect(1100, 10, 101, 41))
        font = QtGui.QFont()
        ...
        self.label_6.setGeometry(QtCore.QRect(380, 40, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.label_5 = QtGui.QLabel(self.frame)
        self.label_5.setGeometry(QtCore.QRect(120, 40, 61, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.checkBox.setGeometry(QtCore.QRect(20, 10, 171, 18))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.checkBox.setFont(font)
        self.checkBox.setObjectName("checkBox")
        self.pB_addchi = QtGui.QPushButton(self.tab_2)
        self.pB_addchi.setGeometry(QtCore.QRect(850, 10, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.pushButton_9.setGeometry(QtCore.QRect(40, 550, 241, 41))
        self.pushButton_9.setObjectName("pushButton_9")
        self.scrollArea_2 = QtGui.QScrollArea(self.tab)
        self.scrollArea_2.setGeometry(QtCore.QRect(20, 70, 281, 471))
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtGui.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 279, 469))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.scrollArea_2.setWidget(self.scrollAreaWidgetContents_2)
        self.widget_3 = QtGui.QWidget(self.tab)
        self.widget_3.setGeometry(QtCore.QRect(330, 20, 871, 571))
        self.widget_3.setObjectName("widget_3")
        self.pushButton_2 = QtGui.QPushButton(self.tab)
        self.pushButton_2.setGeometry(QtCore.QRect(130, 20, 181, 41))
